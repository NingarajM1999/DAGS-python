...
class DailySchedule:
    ...
    def create_dag(self, dag_id, description, start_date, schedule_interval):
        ...
        def second_function_execute(**kwargs):
            ...
            try:
                ...
                response = session.post("http://30.30.30.118:8216/optimize/v1/scheduler/driverDownloadTask", headers=headers)
    ...
    def create_dags_with_tasks(self):
        ...
        dashBoard = self.create_dag(
            dag_id='Schedule_Daily1',
            description='This DAG will Daily ',
...
dags_with_tasks=dailySchedule.create_dags_with_tasks()
dag = dags_with_tasks[0]
task = dag.get_task("sign_in_task")
task1 = dag.get_task("driverDownloadTask")
